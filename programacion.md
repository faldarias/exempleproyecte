...
**Módulo Profesor:** Paco Aldarias

## Introducción

Este módulo introduce al alumnado en la configuración, gestión y mantenimiento de servicios de red e internet, desarrollando competencias técnicas y de resolución de problemas.
...
2. Configuración de DNS y DHCP.
3. Servicios web y transferencia de archivos.
4. Seguridad y mantenimiento.
5. Resolución de problemas y documentación.

## Metodología

Se combinarán explicaciones teóricas, prácticas de laboratorio y trabajos guiados para favorecer el aprendizaje activo.
